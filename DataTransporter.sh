#!/bin/bash
# ------------------------------------------------------------------
# Script name:  DataTransporter.sh
# VERSION:	1.0
# usage:        DataTransporter.sh
# ------------------------------------------------------------------
# Purpose:
#               Moves data in and out of Amazon S3 storage to Hadoop Cluster
#               using functions export and import
# ------------------------------------------------------------------
# Prerequisite:
#               Uses configuration files to store S3 keys (Owned by root)
#               Must Have root access to execute
# ------------------------------------------------------------------
# Author:	Gangadhar Kadam
# ------------------------------------------------------------------
#Example usage
#./DataTransporter.sh export /temp/dir dir aws_parm_file.parm
#./DataTransporter.sh import /temp/dir dir aws_parm_file.parm
#./DataTransporter.sh export gkdb db aws_parm_file.parm
#./DataTransporter.sh import gkdb db aws_parm_file.parm
# ------------------------------------------------------------------
# Revision history:
# 2018-05-30  Created
# ------------------------------------------------------------------
